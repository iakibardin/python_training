...
class test_add_contact(unittest.TestCase):
    ...
    def create_contact(self, wd):
        ...
        wd.find_element_by_name("home").send_keys("11111")
        # mobile telephone
        ...
        wd.find_element_by_name("address2").send_keys("test test test 1")
        # home telephone2
        wd.find_element_by_name("phone2").click()
        wd.find_element_by_name("phone2").clear()
        wd.find_element_by_name("phone2").send_keys("test test test 3")
        # note
        wd.find_element_by_name("notes").click()
        wd.find_element_by_name("notes").clear()
        wd.find_element_by_name("notes").send_keys("testnote")
